...
__twttrlr(function(using, provide, loadrunner, define) {
    provide("util/util", function(e) {
        function t(e) {
            var t = 1,
                n, r;
            for (; n = arguments[t]; t++) for (r in n) if (!n.hasOwnProperty || n.hasOwnProperty(r)) e[r] = n[r];
            return e
        }
        function n(e) {
        ...
        using("dom/delegate", "tfw/util/globals", "util/uri", function(t, n, r) {
            function s() {
                ...
                t.on(window, "message", function(e) {
                    ...
                    t && t.name == "twttr:private:provideArticleUrl" && (i = t.data && t.data.url, n.dnt(t.data.dnt))
    ...
    provide("util/iframe", function(e) {
        e(function(e) {
            ...
            if (e.css) for (r in e.css) e.css.hasOwnProperty(r) && (n.style[r] = e.css[r]);
            if (e.attributes) for (i in e.attributes) e.attributes.hasOwnProperty(i) && n.setAttribute(i, e.attributes[i]);
    ...
    provide("tfw/widget/base", function(e) {
        using("util/util", "util/domready", "dom/get", "tfw/util/globals", "util/querystring", "util/iframe", "util/typevalidator", function(t, n, r, i, s, o, u) {
            ...
            t.aug(p.prototype, {
                ...
                for (; i = e[s]; s++) for (a in t) if (t.hasOwnProperty(a)) {
    ...
    provide("tfw/util/assets", function(e) {
        using("util/env", function(t) {
            ...
            var n = {
                "embed/timeline.css": {
                    "default": "embed/timeline.271d1914b1b100be11f7a7ea7c53ef1a.default.css",
                    "2x": "embed/timeline.271d1914b1b100be11f7a7ea7c53ef1a.2x.css",
                    gif: "embed/timeline.271d1914b1b100be11f7a7ea7c53ef1a.gif.css",
                    "default.rtl": "embed/timeline.271d1914b1b100be11f7a7ea7c53ef1a.default.rtl.css",
                    "2x.rtl": "embed/timeline.271d1914b1b100be11f7a7ea7c53ef1a.2x.rtl.css",
                    "gif.rtl": "embed/timeline.271d1914b1b100be11f7a7ea7c53ef1a.gif.rtl.css"
                }
            };
            e(r)
        })
        ...
        using("tfw/widget/base", "tfw/widget/intent", "tfw/util/assets", "tfw/util/globals", "dom/classname", "dom/delegate", "dom/sandbox", "util/env", "util/twitter", "util/util", function(t, n, r, i, s, o, u, a, f, l) {
            ...
            E.prototype = new t, l.aug(E.prototype, {
                ...
                var n = e.getElementsByTagName("IMG"),
                    ...
                    a = 0,
                    f;
                for (; i = [n, r][a]; a++) if (i.length) for (f = 0; s = i[f]; f++) o = E.scaleDimensions(s.getAttribute("width") || s.width, s.getAttribute("height") || s.height, t, 375), o.width > 0 && (s.width = o.width), o.height > 0 && (s.height = o.height), u = o.height > u ? o.height : u;
                return u
            }, y(), e(E)
        })
    });
        ...
        using("tfw/widget/syndicatedbase", "util/datetime", "anim/transition", "tfw/util/article", "tfw/util/data", "tfw/util/tracking", "tfw/util/params", "util/css", "util/env", "util/iframe", "util/insert", "util/throttle", "util/twitter", "util/querystring", "util/typevalidator", "util/util", "dom/delegate", "dom/classname", "dom/get", function(t, n, r, i, s, o, u, a, f, l, c, h, p, d, v, m, g, y, b) {
            ...
            I.prototype = new t, m.aug(I.prototype, {
                ...
                getTweetDetails: function(e) {
                    ...
                    for (; r = t[a]; a++) i = b.one(_, r, "A"), s = p.status(i.href), o = r.getAttribute("data-tweet-id"), s === o ? n[s] = {
                        item_type: u.TWEET
                    } : n[s] = {
                        item_type: u.RETWEET,
                        target_type: u.TWEET,
    ...
    provide("tfw/widget/embed", function(e) {
        using("tfw/widget/base", "tfw/widget/syndicatedbase", "util/datetime", "tfw/util/params", "dom/classname", "dom/get", "util/env", "util/util", "util/throttle", "util/twitter", "tfw/util/article", "tfw/util/data", "tfw/util/tracking", function(t, n, r, i, s, o, u, a, f, l, c, h, p) {
            ...
            w.prototype = new n, a.aug(w.prototype, {
                ...
                m = {};
                if (e.keys) t = e.keys();
                else for (n in e) e.hasOwnProperty(n) && t.push(n);
                if (!t.length) return;
    ...
    provide("tfw/widget/tweetbutton", function(e) {
        using("tfw/widget/tweetbase", "util/util", "util/querystring", "util/uri", "util/twitter", "dom/textsize", function(t, n, r, i, s, o) {
            ...
            l.prototype = new t, n.aug(l.prototype, {
                ...
                render: function(e, t) {
                    var n = twttr.widgets.config.assetUrl() + "/widgets/tweet_button.1375828408.html#" + this.parameters();
        ...
        using("util/util", "tfw/widget/base", "util/querystring", "util/uri", "util/twitter", "dom/textsize", function(t, n, r, i, s, o) {
            ...
            u.prototype = new n, t.aug(u.prototype, {
                ...
                render: function(e, t) {
                    ...
                    var n = twttr.widgets.config.assetUrl() + "/widgets/follow_button.1375828408.html#" + this.parameters();
    ...
    ! function() {
        ...
        }, using.path.length || (using.path = e() + "://" + twttr.host + "/js"), twttr.ignoreSSL = twttr.ignoreSSL || !1;
        var t = [];
        twttr.events = {
            bind: function(e, n) {
                return t.push([e, n])
            }
        }, using("util/domready", function(n) {
            n(function() {
                using("tfw/widget/base", "tfw/widget/follow", "tfw/widget/tweetbutton", "tfw/widget/embed", "tfw/widget/timeline", "tfw/widget/intent", "tfw/util/article", "util/events", "util/util", function(n, r, i, s, o, u, a, f, l) {
                    function m(t) {
                        var n = twttr.host;
                        return e(t) == "https" && twttr.secureHost && (n = twttr.secureHost), e(t) + "://" + n
                    }
                    function g() {
                    ...
                    p.assetUrl = m, twttr.widgets = twttr.widgets || {}, l.aug(twttr.widgets, {
                        ...
                        load: function(e) {
                            n.init(p), n.embed(e), twttr.widgets.loaded = !0
                        },
                        ...
                        createFollowButton: function(e, t, n, i) {
                            if (!e || !t) return n && n(!1);
                            i = l.aug({}, i || {}, {
                                screenName: e,
                                targetEl: t
                    ...
                    for (c = 0; h = t[c]; c++) twttr.events.bind(h[0], h[1]);
